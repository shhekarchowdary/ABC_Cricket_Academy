...
//        contentValues.put("coachid", coachid);
//        contentValues.put("teamid", teamid);
//        Cursor cursor = DB.rawQuery("Select * from CricketAcademytable where id=?", new String[]  {name});
//        if(cursor.getCount()>0) {
//            long result = DB.update("CricketAcademytable", contentValues, "id=?", new String[]{name});
//        if (result == -1) {
//                return false;
//        } else {
//                return true;
...
//        Cursor cursor = DB.rawQuery("Select * from CricketAcademytable where id=?", new String[]  {name});
//        if(cursor.getCount()>0) {
//            long result = DB.delete("CricketAcademytable", "id=?", new String[]{name});
//            if (result == -1) {
//                return false;
//            } else {
//                return true;
